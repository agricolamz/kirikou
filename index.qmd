...
mano_corpus |> 
  ...
  mutate(PST = str_count(chunk_structure, "PST"),
         ...
         ADV = str_count(chunk_structure, "ADV"),
         ...
         PS = str_count(chunk_structure, "PS") - PST,
         FUR = str_count(chunk_structure, "FUR")) |> 
...
В RS ниукого не встретилась следующая категория
